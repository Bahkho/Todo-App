  ...
  return (
    <div className="flex justify-center items-center h-screen">
      <div className="flex flex-col gap-8 justify-center items-center text-white max-w-[90%] md:max-w-[30%] mx-auto mt-8">
        ...
        <p>
          <b>Thank you for using our application.</b> We appreciate your time
          and trust in our platform. Feel free to return whenever you're ready
          to continue your journey with us. Remember, your data is safe and
          secure until you log in again. Have a great day!
        </p>
